...
namespace Microsoft.EntityFrameworkCore.TestModels.Northwind
{
    public partial class NorthwindData //: IExpectedData
    {
            ...
            where TEntity : class
        {
            ...
            {
                return new EnumerableQuery<TEntity>(_customers.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(Employee))
            {
                return new EnumerableQuery<TEntity>(_employees.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(Order))
            {
                return new EnumerableQuery<TEntity>(_orders.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(OrderDetail))
            {
                return new EnumerableQuery<TEntity>(_orderDetails.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(Product))
            {
                return new EnumerableQuery<TEntity>(_products.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(CustomerView))
            {
                return new EnumerableQuery<TEntity>(_customerViews.Cast<TEntity>());
            }

            if (typeof(TEntity) == typeof(OrderQuery))
            {
                return new EnumerableQuery<TEntity>(_orderQueries.Cast<TEntity>());
            }
